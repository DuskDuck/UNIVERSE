    ...
    public function loadPostsFriends($data , $limit){
        ...
        if(mysqli_num_rows($data_query) > 0){
            ...
            while($row = mysqli_fetch_array($data_query)) {
                ...
                if($user_logged_obj->getGroupId() == $added_by_obj->getGroupId()){
                ...
                //if($user_logged_obj->isFriend($added_by)){
                    ...
                    $str .= "<div class='status_post'>
                                <hr style='width:100%;text-align:left;margin-left:0;color: #DEE1E6FF;'>
            ...
            if($count >  $limit){
                $str .= "<input type='hidden' class='nextPage' value='" . ($page + 1) . "'>
                            ...
                            <p class='noMorePostnotify' style='text-align: center;'>($page)</p>";
            }
            else{
                $str .= "<input type='hidden' class='noMorePosts' value='true'><p class='noMorePostnotify' style='text-align: center;'> Welcome to the Server! </p>"; 
            }
        }
        echo $str;
    }
